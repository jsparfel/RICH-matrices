...
# - Script to run fit_table plots
# Usage: qsub -V fit_table_plots.csh
...
##### INSTALL LOCALLY I/O DIRS AND FILES AS REQUIRED BY fit_table plots
##### EXECUTE fit_table W/ OPTION plots
##### COPY OUTPUTS TO OUTPATH

printf '+++++++++++++++++++++++++++++++\n'
printf ' * fit_table: Run fit_table plots\n'
printf '+++++++++++++++++++++++++++++++\n'
...
# INPUT DIR
\cp $inPath/../analyse/options_fit.dat .
